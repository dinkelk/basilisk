...
mkdir -p build_rv32_noelv
cd build_rv32_noelv
pwd
cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_TOOLCHAIN_FILE=../../riscv_noelv.toolchain.cmake ..
cmake --build . --target SimulationDriver
cp SimulationDriver SimulationDriver.elf
file SimulationDriver.elf
/share/ncc-1.0.4-gcc/bin/riscv-gaisler-elf-size SimulationDriver.elf
